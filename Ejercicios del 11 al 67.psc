...
funcion factura_articulo
	...
	Leer n
	Dimension articulos[n]// en este arreglo se van a guardar los nombres de los artículos
	Dimension precioCantidad(n,2)// en este arreglo se guardan el precio y cantidad de cada artículo, teniendo n cantidad de columnas y solo 2 filas
	Dimension precio(n)
