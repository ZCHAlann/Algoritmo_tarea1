//Ejericios secuenciales (Algoritmo y lógica de progrmación)
...
funcion signo_zodiacal
	...
	Repetir
		...
		Escribir "Ingrese su dia y mes de nacimiento: ";leer dia,mes//se lee la  fecha de nacimiento
...
Funcion calculadora_desc
	...
	Escribir "Precio total a pagar: ",(precio*(descuento/100))
...
Funcion calculadora_impues
	...
	si salario <= 10000
		...
		Escribir "Su total a pagar es: $",(salario*(5/100))// se imprime el total a pagar
	SiNo
...
funcion adivina_numero
	...
	n = azar(100)// se genera el número al azar
	v = Falso// se inicializa la variable lógica como Falso
	Mientras v == Falso Hacer// se desarrolla el Mientras 
		Escribir "Ingrese su número: "; leer m// pedimos el número al usuario
...
funcion suma_arreglo
	...
	definir arre,i,n,sum,j Como Entero//definimos las variables a usar
